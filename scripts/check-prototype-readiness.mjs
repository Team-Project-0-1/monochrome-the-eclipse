...
// After the app was flattened, the app and the repo share a single root.
// The two names are kept to make read sites self-documenting.
...
const dataStages = readText(appDir, 'src/data/dataStages.ts');
