...
const baseNodePresentation: Record<NodeType, Omit<NodePresentation, 'routeName' | 'routeHint' | 'senseHint'>> = {
  ...
  [NodeType.SHOP]: {
    ...
    rewardLevel: 2,
    stake: '현재 빌드 보정',
    className: 'border-cyan-400/45 bg-cyan-950/45 text-cyan-50 hover:border-cyan-300 hover:bg-cyan-900/55',
    lineClassName: 'from-cyan-500/0 via-cyan-300/80 to-cyan-500/0',
  ...
  [NodeType.MINIBOSS]: {
    ...
    rewardLevel: 4,
    stake: '고위험 성장',
    className: 'border-red-400/65 bg-red-950/60 text-red-50 hover:border-red-300 hover:bg-red-900/70',
    lineClassName: 'from-red-500/0 via-red-200/90 to-red-500/0',
  ...
  [NodeType.BOSS]: {
    ...
    rewardLevel: 5,
    stake: '런 진행 관문',
    className: 'border-red-300/75 bg-red-950/70 text-red-50 hover:border-red-200 hover:bg-red-900/80',
    lineClassName: 'from-red-500/0 via-red-200/95 to-red-500/0',
    iconClassName: 'text-red-100',
  },
  [NodeType.UNKNOWN]: {
    label: '미확인',
